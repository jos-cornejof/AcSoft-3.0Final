...
<div class="slider">
    <ul>
        <li><img src="assets/img/galeria/1.png" alt=""></li>
        <li><img src="assets/img/galeria/2.png" alt=""></li>
        <li><img src="assets/img/galeria/3.png" alt=""></li>
        <li><img src="assets/img/galeria/4.png" alt=""></li>
        <li><img src="assets/img/galeria/5.png" alt=""></li>
        <li><img src="assets/img/galeria/6.png" alt=""></li>
        <li><img src="assets/img/galeria/7.png" alt=""></li>
        <li><img src="assets/img/galeria/8.png" alt=""></li>
        <li><img src="assets/img/galeria/9.png" alt=""></li>
        <li><img src="assets/img/galeria/10.png" alt=""></li>
    </ul>
</div>
<footer>
